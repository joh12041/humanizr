...
./op-classifier/src/ml-classifier/scripts/classifier --model_file resources/model.model -o $OUTPUT $DIR/op-classifier/src/ml-classifier/src/ml2/libsvm_settings.txt ./organization_personal_testing.json
